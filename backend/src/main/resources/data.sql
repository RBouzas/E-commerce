...
('Monitor Dell UltraSharp', 'Monitor Dell UltraSharp de 27 pulgadas con resolución 4K UHD, panel IPS y tecnología de calibración de color.', 399.99, '/images/dell_ultrasharp.jpg', 0),
('Disco Duro Externo Seagate', 'Disco duro externo Seagate de 2TB con conexión USB 3.0, ideal para almacenar grandes cantidades de datos y copias de seguridad.', 89.99, '/images/seagate_2tb.jpg', 3),
...
('Laptop Gaming MSI GF65 Thin', 'Laptop gaming MSI GF65 Thin con pantalla de 15.6 pulgadas, procesador Intel Core i7, 16GB de RAM y tarjeta gráfica NVIDIA GeForce GTX 1660 Ti.', 1099.99, '/images/msi_gf65_thin.jpg', 0),
